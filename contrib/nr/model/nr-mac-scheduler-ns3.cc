...
void
NrMacSchedulerNs3::SetEnableBootstrapMcsLimit(bool v)
{
    NS_LOG_FUNCTION(this);
    m_enableBootstrapMcsLimit = v;
}

bool
NrMacSchedulerNs3::IsBootstrapMcsLimitEnabled() const
{
    NS_LOG_FUNCTION(this);
    return m_enableBootstrapMcsLimit;
}
